      ...
      <main className="min-h-screen">
        ...
        <section className="relative w-full min-h-[65vh] md:min-h-[75vh] flex flex-col items-center justify-center overflow-hidden py-10 md:py-16">
          ...
          <div className="relative z-20 text-center text-white px-4 md:px-6 max-w-5xl mx-auto w-full">
            ...
            <div className="flex flex-col sm:flex-row gap-4 md:gap-6 lg:gap-8 justify-center items-center mb-8 md:mb-10">
              <ContactModal type="Queja">
                <button 
                  ...
                  className="transform hover:scale-105 active:scale-95 transition-all duration-300 drop-shadow-lg focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-white focus-visible:ring-offset-black border-none bg-transparent p-0 min-h-[44px] flex items-center justify-center"
                >
                  <Image
                    ...
                    width={160}
                    height={48}
                    className="object-contain w-[140px] h-[44px] sm:w-[160px] sm:h-[48px] md:w-[180px] md:h-[54px] lg:w-[200px] lg:h-[60px]"
                    style={{ width: "auto", height: "auto" }}
                  />
                </button>
              </ContactModal>
            ...
            {/* Social Media Icons */}
            <div className="flex justify-center items-center gap-4 sm:gap-5 md:gap-6 lg:gap-7 flex-wrap max-w-lg mx-auto">
              {/* Facebook */}
              <a 
                ...
                className="text-white hover:text-purple-300 transition-all duration-300 transform hover:scale-110 active:scale-95 p-2 rounded-full focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-purple-400"
              >
