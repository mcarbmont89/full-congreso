...
export async function POST(request: NextRequest) {
  try {
    ...
    // Validate file size (max 10MB for images, 200MB for audio)
    const maxSize = (file.type.startsWith('audio/') || file.name.toLowerCase().endsWith('.mp3')) ? 200 * 1024 * 1024 : 10 * 1024 * 1024
